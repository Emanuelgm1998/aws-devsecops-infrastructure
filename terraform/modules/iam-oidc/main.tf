  ...
  assume_role_policy = jsonencode({
    ...
    Statement = [{
      ...
      Condition = {
        ...
        StringLike = {
          "token.actions.githubusercontent.com:sub" = "repo:Emanuelgm1998/aws-devsecops-infrastructure:*"
        }
      }
    }]
  })
...
output "role_arn" {
  description = "ARN used by GitHub Actions to authenticate through OIDC"
